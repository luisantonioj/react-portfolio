          ...
          <div className="container">
              ...
              <div className="collapse navbar-collapse" id="navbarNav">
                  <ul className="navbar-nav ms-auto">
                      <li className="nav-item"><a className="nav-link" href="#home">About Me</a></li>
        ...
        <div className="modal-dialog modal-lg">
            <div className="modal-content">
                <div className="modal-header">
                    <h5 className="modal-title"><i className="bi bi-rocket-takeoff-fill"></i> Enrollment Management System </h5>
        ...
        <div className="container">
            ...
            <div class="social-icons">
                <a href="https://www.facebook.com/luisantonio.jopia.1" 
                    ...
                    class="social-link" 
                    aria-label="Visit Luis Antonio on Facebook">
